...
public static class SaveBridge
{
    ...
    // SaveBridge.DeleteKeyPP
    public static void DeleteKeyPP(string key)
    {
#if UNITY_SWITCH
        cache.DeleteKey(key);
#else
     //   ObscuredPrefs.DeleteKeyPP(key);
#endif
    }
...
// #endif
//     }
//     public static string GetStringOP(string key)
//     {
// #if UNITY_SWITCH
...
//     }
//
//     // SaveBridge.SetUIntOP
//     public static void SetUIntOP(string key, uint defaultValue = 0)
//     {
// #if UNITY_SWITCH
//         cache.Load(key, defaultValue);
// #else
//         ObscuredPrefs.SetUInt(key, defaultValue);
// #endif
//     }
//
//     // SaveBridge.GetUIntOP
//     public static uint GetUIntOP(string key, uint defaultValue = 0)
//     {
// #if UNITY_SWITCH
//         return cache.Load(key, defaultValue);
// #else
//         return ObscuredPrefs.GetUInt(key, defaultValue);
// #endif
//     }
//
//     // SaveBridge.SetUIntOP
//     public static void SetLongOP(string key, long defaultValue = 0)
//     {
// #if UNITY_SWITCH
//         cache.Load(key, defaultValue);
// #else
//         ObscuredPrefs.SetLong(key, defaultValue);
// #endif
//     }
//
//     // SaveBridge.GetUIntOP
//     public static long GetLongOP(string key, long defaultValue = 0)
//     {
// #if UNITY_SWITCH
//         return cache.Load(key, defaultValue);
// #else
...
// #endif
//     }
//     // SaveBridge.SetDoubleOP
//     public static void SetDoubleOP(string key, double defaultValue = 0)
//     {
// #if UNITY_SWITCH
//         cache.Load(key, defaultValue);
// #else
//         ObscuredPrefs.SetDouble(key, defaultValue);
// #endif
//     }
//
//     // SaveBridge.GetDoubleOP
//     public static double GetDoubleOP(string key, double defaultValue = 0)
//     {
// #if UNITY_SWITCH
//         return cache.Load(key, defaultValue);
// #else
...
// #endif
//     }
//     // SaveBridge.SetRectOP
//     public static void SetRectOP(string key, Rect defaultValue = new Rect())
//     {
// #if UNITY_SWITCH
//         cache.Load(key, defaultValue);
// #else
//         ObscuredPrefs.SetRect(key, defaultValue);
// #endif
//     }
//
//     // SaveBridge.GetRectOP
//     public static Rect GetRectOP(string key, Rect defaultValue = new Rect())
//     {
// #if UNITY_SWITCH
//         return cache.Load(key, defaultValue);
// #else
//         return ObscuredPrefs.GetRect(key, defaultValue);
// #endif
//     }
//     // SaveBridge.SetByteArrayOP
//     public static void SetByteArrayOP(string key, byte[] defaultValue)
//     {
// #if UNITY_SWITCH
//         cache.Load(key, defaultValue);
// #else
//         ObscuredPrefs.SetByteArray(key, defaultValue);
// #endif
//     }
//
//     // SaveBridge.GetByteArrayOP
//     public static byte[] GetByteArrayOP(string key, byte defaultValue = 0, int lenght = 0)
//     {
// #if UNITY_SWITCH
//         return cache.Load<byte[]>(key);
// #else
//         return ObscuredPrefs.GetByteArray(key, defaultValue, lenght);
// #endif
//     }
//
//     // SaveBridge.DeleteKeyOP
//     public static void DeleteKeyOP(string key)
//     {
// #if UNITY_SWITCH
//         cache.DeleteKey(key);
// #else
